...
class User(AbstractUser):
    ...
    role=models.CharField(max_length=15,choices=ROLE_OPTION,default="STUDENT")
...
class InstructorProfile(models.Model):
    ...
    discription=models.CharField(max_length=60,null=True)
...
class Course(models.Model):
    ...
    picture=models.ImageField(upload_to="courseimage",null=True,blank=True,default="courseimage/default.png")
